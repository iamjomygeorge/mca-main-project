      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-zinc-500 dark:text-zinc-400">
            Monitor and manage registered readers and authors.
          </p>
        </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-zinc-900 dark:text-zinc-100">
                            {user.full_name}
                            {user.role === "AUTHOR" && (
                              <span className="ml-2 text-[10px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded border border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800">
                                Author
                              </span>
                            )}
                          </div>
