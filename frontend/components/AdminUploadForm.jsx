...
export default function AdminUploadForm() {
  ...
  const commonInputClasses =
    "block w-full appearance-none rounded-md border-3 border-neutral-200 px-4 py-2 text-zinc-9000 placeholder-zinc-500 focus:border-neutral-400 focus:outline-none focus:ring-zinc-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-50 sm:text-sm";
